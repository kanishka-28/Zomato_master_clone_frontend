            ...
            <div>
                <div className="my-4 mb-6 mx-1">
                    ...
                    <div className="">
                        ...
                        <div className={`w-52 h-40 bg-blacky-300 text-white absolute z-10 ${display} text-center p-2 text-sm`}><RiArrowUpSFill className="absolute b-56 l-24" />The cost for two is computed as follows: 2 desserts + 2 beverages. The actual cost you incur at a restaurant might change depending on your appetite, or with changes in restaurant menu prices.</div>
                    </div>
                ...
                <div className="flex justify-between">
                    <div className="">
                        <p className="flex items-center my-2"><FiCheckCircle className="text-green-600 w-5 h-5 mr-2" /><p className="font-light text-gray-800">Home Delivery</p></p>
                    ...
                    <div className="">
                        ...
                        <p className="flex items-center my-2"><FiCheckCircle className="text-green-600 w-5 h-5 mr-2" /><p className="font-light text-gray-800">Indoor Services</p></p>
        ...
        <><div className="md:hidden">
            <div className="flex justify-center">
                <div className="justify-between">
                    <Div2 />
                    <div className="p-8"><Div1 className="p-6" /></div>
                </div>
            </div>
        </div>
