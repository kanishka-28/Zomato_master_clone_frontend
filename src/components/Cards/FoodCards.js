    ...
    return (
        <div className="w-full h-full my-4 rounded-lg shadow-lg relative">
            <div className="rounded-lg shadow">
                <img src="https://b.zmtcdn.com/data/pictures/3/1400503/33cd8b55cb8da36d780932988a56ebde_o2_featured_v2.jpg" className="w-full h-full rounded-lg shadow-md" />
            </div>
            ...
            <div className="flex justify-between m-2">
                <h1 className="font-bold font-medium">Rasogulla House</h1>
