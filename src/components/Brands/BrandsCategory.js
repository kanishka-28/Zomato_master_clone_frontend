...
//Component
import { NextArrow, PrevArrow } from "../Carousal/Arrows.component";
        ...
        <Slider {...settingsLg}>
          {
            images.map((image) => (
              <div className='px-2'>
                ...
                />
                <h1 className="text-sm font-light text-center">35 min</h1>
              </div>
            ))
          }
    ...
    <>
      ...
      <div className="hidden md:block mx-4">
        <Slider {...settingsLg}>
          {
            images.map((image) => (
              <div className='px-2 h-36 w-24'>
                <img
                  src={image}
                  alt="Burger"
                  className="w-full h-full rounded-md"
                />
                <h1 className="text-md font-light text-center">35 min</h1>
              </div>
            ))
          }
